...
Next, in section \ref{section:data}, we describe the process used to generate the wineries dataset and extract noisy object tags from geotagged images. Then, we describe the object ownership assignment process in section \ref{section:ownership}, and the search process in \ref{section:search}. 
