...
\begin{enumerate}
    ...
    \item Querying the OSM API to ingest crowd-sourced object tags and their coordinates.
...
We annotated the objects manually using \textit{Google Earth Professional \footnote{\href{https://www.google.com/earth/about/versions/}{https://www.google.com/earth/about/versions/}} version 7.3}. 
...
\emph{GESTALT} can also ingest object and location tags by querying the OSM API
