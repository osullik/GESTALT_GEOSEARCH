...
\textit{Objects} can also have attributes that provide amplifying information about them, like \textit{color, material, size, species, etc.}. 
...
We support ingesting hand-labeled objects and locations that have been manually annotated by a trustworthy source. 
...
%\footnote{\href{https://www.google.com/earth/about/versions/}{https://www.google.com/earth/about/versions/}} 
...
\begin{table}[h]
    \begin{center}
        ...
        \begin{tabular}{ |c|c|c|c|c|c| } 
            ...
            \hline
        \end{tabular}
        \caption{Location and object datasets in \emph{GESTALT}. Rows corresponding to the Swan Valley region and having Hand Labels are part of the Swan Valley Wineries dataset we contribute.} %The Swan Valley Wineries dataset supports testing and verification with hand-curated data, and the much larger DC Dataset tests the scalability of \textit{GESTALT}} 
        \vspace{-25pt}
        \label{table:DataSet}
    \end{center}
\end{table}
