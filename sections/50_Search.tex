...
We hand labeled the ground truth responses for 24 spatial queries on object configurations for objects belonging to 6 wineries in the Swan Valley Wineries dataset. For reproducibility, we provide the queries in the form of object names and their spatial configurations, as well as the expected results set for each query.
